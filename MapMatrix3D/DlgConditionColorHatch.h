#if !defined(AFX_DLGCONDITIONCOLORHATCH_H__EF6FF6E4_E869_44AD_8A98_9507D2C41258__INCLUDED_)
#define AFX_DLGCONDITIONCOLORHATCH_H__EF6FF6E4_E869_44AD_8A98_9507D2C41258__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// DlgConditionColorHatch.h : header file
//
...
class CDlgConditionColorHatch : public CDialog
{
// Construction
public:
	CDlgConditionColorHatch(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlgConditionColorHatch)
	enum { IDD = IDD_COLORHATCH_CONDITION_SETTING };
	CMFCColorButton	m_wndColor;
	CComboBox	m_wndComboFields;
	CListCtrlEx m_wndListConditions;
	float	m_fTransparence;
	//}}AFX_DATA

	CConditionColorHatch m_sym, *m_pSymInput;
	
	CValueTable m_ValTab;

	CEdit m_wndEditForList;

	void SetMem(CConditionColorHatch *pSym, CValueTable &tab);
	void OnEndEdit(int nRow, int nCol);

// Overrides
	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CDlgConditionColorHatch)
	protected:
...
protected:
	...
	//{{AFX_MSG(CDlgConditionColorHatch)
	afx_msg void OnButtonAdd();
	afx_msg void OnButtonDel();
	afx_msg void OnImportTxt();
	afx_msg void OnDefColor();
	afx_msg void OnChangeTransparenceEdit();
	afx_msg void OnSelchangeComboFieldname();
...
#endif // !defined(AFX_DLGCONDITIONCOLORHATCH_H__EF6FF6E4_E869_44AD_8A98_9507D2C41258__INCLUDED_)
