// InPEdit.cpp : implementation file
//
// Adapted by Chris Maunder <cmaunder@mail.com>
// Copyright (c) 1998-2002. All Rights Reserved.
//
// The code contained in this file is based on the original
// CInPEdit from http://www.codeguru.com/listview/edit_subitems.shtml
//
...
CInPEdit::CInPEdit(CWnd* pParent, CRect& rect, DWORD dwStyle, UINT nID,
...
BEGIN_MESSAGE_MAP(CInPEdit, CEdit)
    //{{AFX_MSG_MAP(CInPEdit)
    ON_WM_KILLFOCUS()
    ON_WM_CHAR()
    ON_WM_KEYDOWN()
    ON_WM_GETDLGCODE()
...
////////////////////////////////////////////////////////////////////////////
// CInPEdit message handlers

// If an arrow key (or associated) is pressed, then exit if
//  a) The Ctrl key was down, or
//  b) m_bExitOnArrows == TRUE
void CInPEdit::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
void CInPEdit::OnKillFocus(CWnd* pNewWnd)
{
    CEdit::OnKillFocus(pNewWnd);
    EndEdit();
}

void CInPEdit::OnChar(UINT nChar, UINT nRepCnt, UINT nFlags)
{
...
BOOL CInPEdit::PreTranslateMessage(MSG* pMsg) 
{
...
////////////////////////////////////////////////////////////////////////////
// CInPEdit implementation

void CInPEdit::EndEdit()
{
    CString str;
