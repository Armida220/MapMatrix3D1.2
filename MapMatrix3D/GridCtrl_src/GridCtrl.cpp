...
//}}AFX_MSG_MAP
    ...
    ON_NOTIFY(GVN_ENDLABELEDIT, IDC_INPLACE_CONTROL, OnEndInPEdit)
END_MESSAGE_MAP()
...
{  
    ...
    EndEditing();        // destroy any InPEdit's
...
// Callback from any CInPEdits that ended. This just calls OnEndEditCell,
// refreshes the edited cell and moves onto next cell if the return character
// from the edit says we should.
void CGridCtrl::OnEndInPEdit(NMHDR* pNMHDR, LRESULT* pResult)
{
    GV_DISPINFO *pgvDispInfo = (GV_DISPINFO *)pNMHDR;
    GV_ITEM     *pgvItem = &pgvDispInfo->item;

    // In case OnEndInPEdit called as window is being destroyed
...
void CGridCtrl::OnRButtonUp(UINT nFlags, CPoint point)
{
    ...
    EndEditing();        // Auto-destroy any InPEdit's
