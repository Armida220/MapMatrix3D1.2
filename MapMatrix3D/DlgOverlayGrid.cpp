// DlgOverlayGrid.cpp : implementation file
//
...
CDlgOverlayGrid::CDlgOverlayGrid(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgOverlayGrid::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgOverlayGrid)
	m_bOverlay = FALSE;
	m_fHei = 100.0f;
	m_fWid = 100.0f;
	m_fXOrigin = 0.0f;
...
void CDlgOverlayGrid::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgOverlayGrid)
...
BEGIN_MESSAGE_MAP(CDlgOverlayGrid, CDialog)
	//{{AFX_MSG_MAP(CDlgOverlayGrid)
...
void CDlgOverlayGrid::OnOK() 
{
	m_color = m_colorBtn.GetColor();
	CDialog::OnOK();
}

BOOL CDlgOverlayGrid::OnInitDialog() 
{
...
void CDlgOverlayGrid::OnWSRegion() 
{
	UpdateData(TRUE);
...
void CDlgOverlayGrid::OnButtonDem() 
{
	UpdateData(TRUE);
...
void CDlgOverlayGrid::OnChangeEditOgWid() 
{
