...
void CFTRLayerViewBar::OnNcCalcSize(BOOL bCalcValidRects, NCCALCSIZE_PARAMS* lpncsp)
{
...
void CFTRLayerViewBar::OnNcPaint()
{
...
BOOL CFTRLayerViewBar::Dock(CBasePane* pTargetBar, LPCRECT lpRect, AFX_DOCK_METHOD dockMethod)
{
