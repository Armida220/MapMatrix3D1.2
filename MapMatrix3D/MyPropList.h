#if !defined(AFX_MYPROPLIST_H__F6054FED_0317_4829_B7BF_4EBBDC27DF01__INCLUDED_)
#define AFX_MYPROPLIST_H__F6054FED_0317_4829_B7BF_4EBBDC27DF01__INCLUDED_
...
#define WM_UPDATE_FILTER		(WM_USER+2)
#define WM_SEL_CHANGED			(WM_USER+3)
...
protected:
	...
	CBitmap			m_bmProp;		//属性值的位图 勾选与非勾选 以及默认全选 
	BITMAP			m_bmPropInfo;
...
public:	
	...
	void InitHeaderCtrl();
	void EnsureItemVisible(CLVLPropItem0* pProp) //hcw,2013.1.15,让选中的item滚动到可见区。
	{
		//UpdateData(TRUE);
		EnsureVisible(pProp);
		//UpdateData(FALSE);
