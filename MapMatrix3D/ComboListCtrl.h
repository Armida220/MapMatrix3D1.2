...
// Implementation
	...
	// get Item data
	ItemInfo GetItemInfo(int nItem);
...
// Implementation
	...
	// Checks whether item is read only
	bool IsReadOnly(int iItem,int iCol=-1);
...
// Attributes
	...
	CList<int, int> m_ReadOnlyItemsList;
	...
	BOOL m_bFocusOtherWndBeforeClick;
