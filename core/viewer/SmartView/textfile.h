...
It shouldn't be necessary to define which "tech-level" 
...
MyNameSpaceBegin
class EXPORT_SMARTVIEW CTextFileBase
{
public:
...
class EXPORT_SMARTVIEW CTextFileWrite : public CTextFileBase
{
...
class EXPORT_SMARTVIEW CTextFileRead : public CTextFileBase
{
...
private:
	...
	//Used to read \r\n in the beginning of a file correctly. (thanks to drinktea)
	bool m_HeaderCRLF;
...
MyNameSpaceBegin
class EXPORT_SMARTVIEW CTextFileException
{
public:
