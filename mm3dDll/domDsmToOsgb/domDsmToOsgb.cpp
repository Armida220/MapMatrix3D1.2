...
// domDsmToOsgb.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CdomDsmToOsgbApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CdomDsmToOsgbApp construction

CdomDsmToOsgbApp::CdomDsmToOsgbApp()
{
...
// The one and only CdomDsmToOsgbApp object

CdomDsmToOsgbApp theApp;
...
// CdomDsmToOsgbApp initialization

BOOL CdomDsmToOsgbApp::InitInstance()
{
//TODO: call AfxInitRichEdit2() to initialize richedit2 library.
	...
	SetRegistryKey(_T("Visiontek\\FeatureOneGrid\\domDsmToOsgb"));
