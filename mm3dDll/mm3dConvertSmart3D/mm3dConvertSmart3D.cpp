...
// mm3dConvertSmart3D.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(Cmm3dConvertSmart3DApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Cmm3dConvertSmart3DApp construction

Cmm3dConvertSmart3DApp::Cmm3dConvertSmart3DApp()
{
...
// The one and only Cmm3dConvertSmart3DApp object

Cmm3dConvertSmart3DApp theApp;
...
// Cmm3dConvertSmart3DApp initialization

BOOL Cmm3dConvertSmart3DApp::InitInstance()
{
	...
	SetRegistryKey(_T("Visiontek\\FeatureOneGrid\\mm3dConvertSmart3D"));


	Cmm3dConvertSmart3DDlg dlg;
	m_pMainWnd = &dlg;
