...
// extractAerial.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CextractAerialApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CextractAerialApp construction

CextractAerialApp::CextractAerialApp()
{
...
// The one and only CextractAerialApp object

CextractAerialApp theApp;
...
// CextractAerialApp initialization

BOOL CextractAerialApp::InitInstance()
{
	...
	SetRegistryKey(_T("Visiontek\\FeatureOneGrid\\extractAerial"));

	CextractAerialDlg dlg;
	m_pMainWnd = &dlg;
